...
//go:generate go run msgraph-download.go -baseURL https://graph.microsoft.com/v1.0 -out metadata-v1.0.xml
//go:generate go run msgraph-download.go -baseURL https://graph.microsoft.com/beta -out metadata-beta.xml
