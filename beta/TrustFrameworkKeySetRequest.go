...
func (r *TrustFrameworkKeySetRequest) Get() (resObj *TrustFrameworkKeySet, err error) {
	var query string
	if r.query != nil {
...
func (r *TrustFrameworkKeySetRequest) Update(reqObj *TrustFrameworkKeySet) error {
