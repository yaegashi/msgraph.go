...
func (r *EducationRootSynchronizationProfilesCollectionRequest) Add(reqObj *EducationSynchronizationProfile) (resObj *EducationSynchronizationProfile, err error) {
	err = r.JSONRequest("POST", "", reqObj, &resObj)
	return
}
