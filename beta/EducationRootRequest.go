...
// Do performs HTTP request for EducationSynchronizationProfile collection
func (r *EducationRootSynchronizationProfilesCollectionRequest) Do(method, path string, reqObj interface{}) (resObj *EducationSynchronizationProfile, err error) {
	err = r.JSONRequest(method, path, reqObj, &resObj)
	return
}

// Paging perfoms paging operation for EducationSynchronizationProfile collection
func (r *EducationRootSynchronizationProfilesCollectionRequest) Paging(method, path string, obj interface{}) ([]EducationSynchronizationProfile, error) {
	req, err := r.NewJSONRequest(method, path, obj)
	if err != nil {
		return nil, err
	}
...
func (r *EducationRootSynchronizationProfilesCollectionRequest) Get() ([]EducationSynchronizationProfile, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
func (r *EducationRootSynchronizationProfilesCollectionRequest) Add(reqObj *EducationSynchronizationProfile) (*EducationSynchronizationProfile, error) {
	return r.Do("POST", "", reqObj)
}
