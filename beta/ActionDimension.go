...
func (r *DimensionDimensionValuesCollectionRequest) BatchGet(batch *BatchRequest) error {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
func (r *DimensionDimensionValuesCollectionRequest) BatchAdd(batch *BatchRequest, reqObj *DimensionValue) error {
	var resObj []DimensionValue
