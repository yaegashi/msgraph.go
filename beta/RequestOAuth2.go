...
// BatchGet adds Get operation to Batch for OAuth2PermissionGrant
func (r *OAuth2PermissionGrantRequest) BatchGet(batch *BatchRequest) error {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// BatchUpdate adds Update operation to Batch for OAuth2PermissionGrant
func (r *OAuth2PermissionGrantRequest) BatchUpdate(batch *BatchRequest, reqObj *OAuth2PermissionGrant) error {
	return batch.Add("PATCH", strings.TrimPrefix(r.baseURL, defaultBaseURL), reqObj, nil)
}

// BatchDelete adds Delete operation to Batch for OAuth2PermissionGrant
func (r *OAuth2PermissionGrantRequest) BatchDelete(batch *BatchRequest) error {
