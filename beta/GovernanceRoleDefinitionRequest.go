...
func (r *GovernanceRoleDefinitionRequest) Get() (resObj *GovernanceRoleDefinition, err error) {
	var query string
	if r.query != nil {
...
func (r *GovernanceRoleDefinitionRequest) Update(reqObj *GovernanceRoleDefinition) error {
