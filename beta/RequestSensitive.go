...
// BatchGet adds Get operation to Batch for SensitiveType
func (r *SensitiveTypeRequest) BatchGet(batch *BatchRequest) error {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// BatchUpdate adds Update operation to Batch for SensitiveType
func (r *SensitiveTypeRequest) BatchUpdate(batch *BatchRequest, reqObj *SensitiveType) error {
	return batch.Add("PATCH", strings.TrimPrefix(r.baseURL, defaultBaseURL), reqObj, nil)
}

// BatchDelete adds Delete operation to Batch for SensitiveType
func (r *SensitiveTypeRequest) BatchDelete(batch *BatchRequest) error {
