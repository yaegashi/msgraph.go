...
func (r *MacOsVppAppAssignedLicenseRequest) Get() (resObj *MacOsVppAppAssignedLicense, err error) {
	var query string
	if r.query != nil {
...
func (r *MacOsVppAppAssignedLicenseRequest) Update(reqObj *MacOsVppAppAssignedLicense) error {
