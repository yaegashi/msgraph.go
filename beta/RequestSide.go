...
// BatchGet adds Get operation to Batch for SideLoadingKey
func (r *SideLoadingKeyRequest) BatchGet(batch *BatchRequest) error {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// BatchUpdate adds Update operation to Batch for SideLoadingKey
func (r *SideLoadingKeyRequest) BatchUpdate(batch *BatchRequest, reqObj *SideLoadingKey) error {
	return batch.Add("PATCH", strings.TrimPrefix(r.baseURL, defaultBaseURL), reqObj, nil)
}

// BatchDelete adds Delete operation to Batch for SideLoadingKey
func (r *SideLoadingKeyRequest) BatchDelete(batch *BatchRequest) error {
