...
// BatchGet adds Get operation to Batch for ProjectParticipation
func (r *ProjectParticipationRequest) BatchGet(batch *BatchRequest) error {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// BatchUpdate adds Update operation to Batch for ProjectParticipation
func (r *ProjectParticipationRequest) BatchUpdate(batch *BatchRequest, reqObj *ProjectParticipation) error {
	return batch.Add("PATCH", strings.TrimPrefix(r.baseURL, defaultBaseURL), reqObj, nil)
}

// BatchDelete adds Delete operation to Batch for ProjectParticipation
func (r *ProjectParticipationRequest) BatchDelete(batch *BatchRequest) error {
