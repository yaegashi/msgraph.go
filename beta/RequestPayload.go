...
// BatchGet adds Get operation to Batch for PayloadResponse
func (r *PayloadResponseRequest) BatchGet(batch *BatchRequest) error {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// BatchUpdate adds Update operation to Batch for PayloadResponse
func (r *PayloadResponseRequest) BatchUpdate(batch *BatchRequest, reqObj *PayloadResponse) error {
	return batch.Add("PATCH", strings.TrimPrefix(r.baseURL, defaultBaseURL), reqObj, nil)
}

// BatchDelete adds Delete operation to Batch for PayloadResponse
func (r *PayloadResponseRequest) BatchDelete(batch *BatchRequest) error {
