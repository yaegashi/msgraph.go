...
// BatchGet adds Get operation to Batch for TermsAndConditionsGroupAssignment
func (r *TermsAndConditionsGroupAssignmentRequest) BatchGet(batch *BatchRequest) error {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// BatchUpdate adds Update operation to Batch for TermsAndConditionsGroupAssignment
func (r *TermsAndConditionsGroupAssignmentRequest) BatchUpdate(batch *BatchRequest, reqObj *TermsAndConditionsGroupAssignment) error {
	return batch.Add("PATCH", strings.TrimPrefix(r.baseURL, defaultBaseURL), reqObj, nil)
}

// BatchDelete adds Delete operation to Batch for TermsAndConditionsGroupAssignment
func (r *TermsAndConditionsGroupAssignmentRequest) BatchDelete(batch *BatchRequest) error {
	return batch.Add("DELETE", strings.TrimPrefix(r.baseURL, defaultBaseURL), nil, nil)
}
