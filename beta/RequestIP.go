...
// BatchGet adds Get operation to Batch for IPSecurityProfile
func (r *IPSecurityProfileRequest) BatchGet(batch *BatchRequest) error {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// BatchUpdate adds Update operation to Batch for IPSecurityProfile
func (r *IPSecurityProfileRequest) BatchUpdate(batch *BatchRequest, reqObj *IPSecurityProfile) error {
	return batch.Add("PATCH", strings.TrimPrefix(r.baseURL, defaultBaseURL), reqObj, nil)
}

// BatchDelete adds Delete operation to Batch for IPSecurityProfile
func (r *IPSecurityProfileRequest) BatchDelete(batch *BatchRequest) error {
