...
// BatchGet adds Get operation to Batch for EducationalActivity
func (r *EducationalActivityRequest) BatchGet(batch *BatchRequest) error {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// BatchUpdate adds Update operation to Batch for EducationalActivity
func (r *EducationalActivityRequest) BatchUpdate(batch *BatchRequest, reqObj *EducationalActivity) error {
	return batch.Add("PATCH", strings.TrimPrefix(r.baseURL, defaultBaseURL), reqObj, nil)
}

// BatchDelete adds Delete operation to Batch for EducationalActivity
func (r *EducationalActivityRequest) BatchDelete(batch *BatchRequest) error {
