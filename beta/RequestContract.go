...
// BatchGet adds Get operation to Batch for Contract
func (r *ContractRequest) BatchGet(batch *BatchRequest) error {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// BatchUpdate adds Update operation to Batch for Contract
func (r *ContractRequest) BatchUpdate(batch *BatchRequest, reqObj *Contract) error {
	return batch.Add("PATCH", strings.TrimPrefix(r.baseURL, defaultBaseURL), reqObj, nil)
}

// BatchDelete adds Delete operation to Batch for Contract
func (r *ContractRequest) BatchDelete(batch *BatchRequest) error {
