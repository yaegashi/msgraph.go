...
func (r *GroupAppRoleAssignmentsCollectionRequest) Get() ([]AppRoleAssignment, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
func (b *GroupRequestBuilder) Channels() *GroupChannelsCollectionRequestBuilder {
	bb := &GroupChannelsCollectionRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/channels"
	return bb
}

// GroupChannelsCollectionRequestBuilder is request builder for Channel collection
type GroupChannelsCollectionRequestBuilder struct{ BaseRequestBuilder }

// Request returns request for Channel collection
func (b *GroupChannelsCollectionRequestBuilder) Request() *GroupChannelsCollectionRequest {
	return &GroupChannelsCollectionRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ID returns request builder for Channel item
func (b *GroupChannelsCollectionRequestBuilder) ID(id string) *ChannelRequestBuilder {
...
func (r *GroupChannelsCollectionRequest) Get() ([]Channel, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
func (r *GroupEndpointsCollectionRequest) Get() ([]Endpoint, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
func (r *GroupPermissionGrantsCollectionRequest) Get() ([]ResourceSpecificPermissionGrant, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
func (r *GroupSettingsCollectionRequest) Get() ([]DirectorySetting, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
