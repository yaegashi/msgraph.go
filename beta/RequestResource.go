...
// BatchGet adds Get operation to Batch for ResourceOperation
func (r *ResourceOperationRequest) BatchGet(batch *BatchRequest) error {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// BatchUpdate adds Update operation to Batch for ResourceOperation
func (r *ResourceOperationRequest) BatchUpdate(batch *BatchRequest, reqObj *ResourceOperation) error {
	return batch.Add("PATCH", strings.TrimPrefix(r.baseURL, defaultBaseURL), reqObj, nil)
}

// BatchDelete adds Delete operation to Batch for ResourceOperation
func (r *ResourceOperationRequest) BatchDelete(batch *BatchRequest) error {
...
// BatchGet adds Get operation to Batch for ResourceSpecificPermissionGrant
func (r *ResourceSpecificPermissionGrantRequest) BatchGet(batch *BatchRequest) error {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// BatchUpdate adds Update operation to Batch for ResourceSpecificPermissionGrant
func (r *ResourceSpecificPermissionGrantRequest) BatchUpdate(batch *BatchRequest, reqObj *ResourceSpecificPermissionGrant) error {
	return batch.Add("PATCH", strings.TrimPrefix(r.baseURL, defaultBaseURL), reqObj, nil)
}

// BatchDelete adds Delete operation to Batch for ResourceSpecificPermissionGrant
func (r *ResourceSpecificPermissionGrantRequest) BatchDelete(batch *BatchRequest) error {
	return batch.Add("DELETE", strings.TrimPrefix(r.baseURL, defaultBaseURL), nil, nil)
}
