...
// Do performs HTTP request for UserConfiguration collection
func (r *MailFolderUserConfigurationsCollectionRequest) Do(method, path string, reqObj interface{}) (resObj *UserConfiguration, err error) {
	err = r.JSONRequestWithPath(method, path, reqObj, &resObj)
	return
}

// Paging perfoms paging operation for UserConfiguration collection
func (r *MailFolderUserConfigurationsCollectionRequest) Paging(method, path string, obj interface{}) ([]UserConfiguration, error) {
	req, err := r.NewJSONRequestWithPath(method, path, obj)
	if err != nil {
		return nil, err
	}
...
func (r *MailFolderUserConfigurationsCollectionRequest) Get() ([]UserConfiguration, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
func (r *MailFolderUserConfigurationsCollectionRequest) Add(reqObj *UserConfiguration) (*UserConfiguration, error) {
	return r.Do("POST", "", reqObj)
}
