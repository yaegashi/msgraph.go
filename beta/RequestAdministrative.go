...
// BatchGet adds Get operation to Batch for AdministrativeUnit
func (r *AdministrativeUnitRequest) BatchGet(batch *BatchRequest) error {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// BatchUpdate adds Update operation to Batch for AdministrativeUnit
func (r *AdministrativeUnitRequest) BatchUpdate(batch *BatchRequest, reqObj *AdministrativeUnit) error {
	return batch.Add("PATCH", strings.TrimPrefix(r.baseURL, defaultBaseURL), reqObj, nil)
}

// BatchDelete adds Delete operation to Batch for AdministrativeUnit
func (r *AdministrativeUnitRequest) BatchDelete(batch *BatchRequest) error {
