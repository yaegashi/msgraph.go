...
func (r *MobileAppContentFileRequest) Get() (resObj *MobileAppContentFile, err error) {
	var query string
	if r.query != nil {
...
func (r *MobileAppContentFileRequest) Update(reqObj *MobileAppContentFile) error {
