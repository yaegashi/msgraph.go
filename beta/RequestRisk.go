...
// BatchGet adds Get operation to Batch for RiskDetection
func (r *RiskDetectionRequest) BatchGet(batch *BatchRequest) error {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// BatchUpdate adds Update operation to Batch for RiskDetection
func (r *RiskDetectionRequest) BatchUpdate(batch *BatchRequest, reqObj *RiskDetection) error {
	return batch.Add("PATCH", strings.TrimPrefix(r.baseURL, defaultBaseURL), reqObj, nil)
}

// BatchDelete adds Delete operation to Batch for RiskDetection
func (r *RiskDetectionRequest) BatchDelete(batch *BatchRequest) error {
